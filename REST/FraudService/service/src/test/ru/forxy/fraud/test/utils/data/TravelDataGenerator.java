...
public abstract class TravelDataGenerator extends AbstractGenerator {
    ...
    public static Product generateProduct(final String name, final double amount) {
    ...
    private static <T extends Product> T fillProductData(final T product, final double amount) {
        product.setPrice(generatePrice(amount));
        return product;
    }
    ...
    public static Price generatePrice(final double amount) {
        return fillAmountData(new Price(), amount);
    }
