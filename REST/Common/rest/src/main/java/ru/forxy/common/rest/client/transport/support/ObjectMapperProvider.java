package ru.forxy.common.rest.client.transport.support;
...
public final class ObjectMapperProvider {
    ...
    /**
     * Builds the mapper with the default configuration. See {@link ru.forxy.common.rest.client.transport.support.ObjectMapperProvider.Config} for the details about
