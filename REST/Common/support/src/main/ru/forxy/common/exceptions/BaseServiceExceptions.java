...
public enum BaseServiceExceptions {
    ...
    DataBaseIsNotAvailable(new StatusTemplate("1000", "Data base on host '%s' is not available. Please check the connection settings.")),
    DataBaseTimeout(new StatusTemplate("1001", "The connection timeout exceeded for data base on host '%s'. Please check the connection settings."));
